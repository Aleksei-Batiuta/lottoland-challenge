...
public class SignEnumTest extends AbstractTest {
  ...
  public static Stream<? extends Arguments> testData() {
    return Stream.of(Arguments.of(ROCK, null, WIN),
        Arguments.of(ROCK, ROCK, DRAW), Arguments.of(ROCK, PAPER, LOSS),
        Arguments.of(ROCK, SCISSORS, WIN), Arguments.of(PAPER, null, WIN),
        Arguments.of(PAPER, ROCK, WIN), Arguments.of(PAPER, PAPER, DRAW),
        Arguments.of(PAPER, SCISSORS, LOSS), Arguments.of(SCISSORS, null, WIN),
        Arguments.of(SCISSORS, ROCK, LOSS), Arguments.of(SCISSORS, PAPER, WIN),
  ...
  public void test(final SignEnum firstSign, final SignEnum secondSign,
    ...
    assertEquals(
        String.format("Test case was failed: {first = %s, second = %s}",
  ...
  @Test
  void testSignStatus() {
    assertEquals("Constant WIN was changed", WIN.getStatus(),
        SignEnum.Const.WIN);
    assertEquals("Constant DRAW was changed", DRAW.getStatus(),
        SignEnum.Const.DRAW);
    assertEquals("Constant LOSS was changed", LOSS.getStatus(),
        SignEnum.Const.LOSS);
  }
}
