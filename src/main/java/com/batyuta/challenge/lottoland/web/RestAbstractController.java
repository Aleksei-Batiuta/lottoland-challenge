...
public abstract class RestAbstractController
        <T extends BaseEntity<T>, V extends BaseVO> {
    /**
    ...
    public Page<V> findAll(final @RequestHeader(value = CSRF, required = false)
                                   UserEntity user,
    ...
    public EntityModel<V> save(final @RequestBody V view) {
        ...
        return getEntityModel(
                lightweightService.toView(service.save(entity)),
                Pageable.unpaged()
        );
    }
    ...
    public EntityModel<V> put(final @RequestParam Long id,
        ...
        entity.setId(id);
        return getEntityModel(
                lightweightService.toView(service.replace(entity)),
                Pageable.unpaged()
        );
    }
    ...
    public EntityModel<V> patch(final @PathVariable Long id,
        ...
        entity.setId(id);
        return getEntityModel(
                lightweightService.toView(service.update(entity)),
                Pageable.unpaged()
        );
    }
