...
/**
 * Controller Advice catches the app exceptions and returns correct RESP
 * response.
 */
@ControllerAdvice
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ResponseBody
  public RestResponse<ErrorBody> handleBaseException(final BaseException ex,
      final WebRequest request) {
    String message = messageSource.getMessage(ex.getKey(), ex.getArgs(),
        request.getLocale());
  ...
  @ResponseBody
  public RestResponse<ErrorBody> handleAccessDeniedException(final Exception ex,
      final WebRequest request) {
  ...
  @ResponseBody
  public RestResponse<ErrorBody> handleThrowable(final Exception ex,
      final WebRequest request) {
    setMessageAttribute(request, ex.getMessage(), ex);
  ...
  private void setMessageAttribute(final WebRequest request,
