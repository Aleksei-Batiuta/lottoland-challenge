...
public class RoundEntity extends BaseEntity<RoundEntity> {
	 ...
	 */
	public RoundEntity(final Long user, final SignEnum player1Enum, final SignEnum player2Enum,
	 ...
	 * @param statusEnum status
	 */
	public RoundEntity(final Long roundId, final Long user, final SignEnum player1Enum, final SignEnum player2Enum,
			final StatusEnum statusEnum) {
		super(roundId);
		this.userid = user;
	...
	public String toString() {
		return MessageFormat.format(
				"RoundEntity'{'id={0}, userid={1}, player1={2}, player2={3}, " + "status={4}, deleted={5}'}'", getId(),
				userid, player1, player2, status, deleted);
	}
	...
	public int compareTo(final RoundEntity o) {
		Comparator<RoundEntity> comparator = Comparator.nullsFirst(Comparator.comparing(BaseEntity::getId));
