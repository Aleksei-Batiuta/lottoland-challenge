...
public class UserRestController extends AbstractRestController<UserEntity, UserVO> {

    public UserRestController(UserEntityService service, UserLightweightService lightweightService) {
