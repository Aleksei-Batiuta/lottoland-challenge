...
public class PropertyValueUtilsBean {
     ...
     * Property utils.
     */
    private final org.apache.commons.beanutils.PropertyUtilsBean
     ...
     */
    @LogEntry
    public <P extends Comparable<? super P>> P getProperty(
            final Sort.Order order, final Object o) {
        try {
            return (P) propertyUtils
                    .getProperty(o, order.getProperty());
        } catch (Exception e) {
