...
public class RestUserController extends AbstractController<UserEntity, UserVO> {
   ...
   */
  public RestUserController(final UserEntityService service,
      final UserLightweightService lightweightService) {
