...
public class LogEntryData {
   ...
   */
  public LogEntryData(final String methodName, final String[] parameters,
      final Object[] arguments, final Instant startTime,
  ...
  public String duration() {
    if (unit != null && start != null && end != null) {
      return String.format("%s %s", unit.between(start, end),
