...
public class SortComparator<T extends Comparable<? super T>> implements Comparator<T> {
  ...
  /** Property Value bean. */
  @Autowired private PropertyValueUtilsBean propertyBean;
   ...
   * @return comparator
   */
  private <P extends Comparable<? super P>> Comparator<T> getSortOrderComparator(
    ...
    Comparator<T> comparator =
        Comparator.comparing(o -> propertyBean.getProperty(order, o), orderComparator);
